...
public class ZPLConverter {
    ...
    public String convertFromImage(Bitmap image, Boolean addHeaderFooter,Boolean isSinglePrint) {
        ...
        if (addHeaderFooter) {
            ...
            header += "^XA #SPACE " + "^FO0,0^GFA," + total + "," + total + "," + widthBytes + ", ";
            //String footer = "^FS" + "^XZ";
          //  String footer = "^FS" + "^XZ ^XA ~JA ^XZ";
            String footer = "^FS" + "^XZ ^XA ^LL100 ^XZ";
