...
public class SelectedJobListAdapter extends RecyclerView.Adapter<SelectedJobListAdapter.MyViewHolder> {
    List<Job> jobs;
    Context context;
...
//            txt_town_pin = (TextView) view.findViewById(R.id.txt_town_pin);
    ...
    public SelectedJobListAdapter(List<Job> jobs, Context context, RecyclerViewClickListener itemListener) {
        this.jobs = jobs;
