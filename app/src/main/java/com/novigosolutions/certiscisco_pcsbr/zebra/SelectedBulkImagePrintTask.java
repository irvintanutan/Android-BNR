...
public class SelectedBulkImagePrintTask extends AsyncTask<Void, Integer, Boolean> {

    private PrintSelectedJobActivity context;
    private ZebraPrinter printer;
    private Connection connection;
    private List<String> printList;
    private String status;

    public SelectedBulkImagePrintTask(PrintSelectedJobActivity context, ZebraPrinter printer,
