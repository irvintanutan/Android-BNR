package com.novigosolutions.certiscisco_pcsbr.ui;
...
public class SignatureView extends View {
    ...
    public String getByteArray() {
        Bitmap bmp = getSignature();
        Bitmap emptyBitmap = Bitmap.createBitmap(bmp.getWidth(), bmp.getHeight(),Bitmap.Config.RGB_565);
        ...
        if (bmp.sameAs(emptyBitmap)) {
            ...
            String sign = Base64.encodeToString(byteArray, Base64.DEFAULT);
            bmp.recycle();
            return sign;
        }
    }
