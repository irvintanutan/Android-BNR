...
public class SelectedJobGridAdapter extends RecyclerView.Adapter<SelectedJobGridAdapter.MyViewHolder> {
    List<Job> jobs;
    ...
    public SelectedJobGridAdapter(List<Job> jobs, RecyclerViewClickListener itemListener, Context context) {
        this.jobs = jobs;
